...
use sea_orm::{EntityTrait, QueryFilter, ColumnTrait, ActiveModelTrait, Set, ConnectionTrait};
use uuid::Uuid;
...
pub async fn find_coastal_locations_needing_tidal_update(db: &Database, hours_threshold: i64) -> anyhow::Result<Vec<location::Model>> {
